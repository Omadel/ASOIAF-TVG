...
public class MixamoManager : EditorWindow {
    ...
    private class Settings {
        ...
        public bool rename_anim_clips = false;
        public bool rename_anim_clips_underscores = false;
        public bool rename_anim_clips_no_spaces = false;
        public bool rename_anim_clips_tolower = false;
        public bool change_loop_anim_clips = false;
        public bool loop_anim_clips_time = false;
        ...
        public bool disable_material_import = false;
        public bool mirror = false;
        public bool set_rig_to_humanoid = false;
        public Avatar rig_custom_avatar;
    }

    [MenuItem("Window/MixamoManager")]
    ...
    private void OnGUI() {
        ...
        settings.rename_anim_clips = EditorGUILayout.BeginToggleGroup("Rename anim clips to filename", settings.rename_anim_clips);
        {
            ...
            settings.rename_anim_clips_no_spaces = EditorGUILayout.Toggle("No Spaces, No Underscores", settings.rename_anim_clips_no_spaces);
    ...
    private void RenameAndImport(ModelImporter asset, string name) {
        ...
        if(settings.rename_anim_clips_no_spaces) {
            name = name.Replace("_", "");
            name = name.Replace(" ", "");
        }
        ...
        for(int i = 0; i < clipAnimations.Length; i++) {
            ...
            if(settings.change_loop_anim_clips) {
                ...
                if(settings.root_transform_rotation) {
                    ...
                    clip.lockRootHeightY = settings.root_transform_rotation_bakeintopose;
                    clip.lockRootPositionXZ = settings.root_transform_rotation_bakeintopose;
